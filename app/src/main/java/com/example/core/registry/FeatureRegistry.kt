...
object FeatureRegistry {
  ...
  val features: List<FeatureContract> = listOf(
    ...
    FeatureContract(
      id = "FIRE-005",
      name = "Map",
      purpose = "Visualisasi peta geografis wilayah",
      input = "Koordinat terverifikasi",
      process = "Belum dimulai",
      output = "Layer peta nyata",
      dataSource = "Tile provider nyata",
      dependencies = emptyList(),
      successCriteria = "Peta tampil dengan koordinat nyata",
      failureCriteria = "Marker contoh dibuat tanpa data nyata",
      testProcedure = "Menunggu spesifikasi tahap berikutnya",
